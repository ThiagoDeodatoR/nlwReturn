...
export function FeedBackSuccessStep( { onFeedBackRestartRequest } : FeedBackSuccessStepProps ) {
    return (
        <>
            ...
            <div className="flex flex-column items-center justify-center pt-10 pb-6 w-[304px]">
            ...
            <span className="text-xl">Agradecemos o seu FeedBack!</span>

            <button
                type="button"
                onClick={onFeedBackRestartRequest}
                className="py-2 px-6 my-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 hover:ring-2 hover:ring-offset-2 hover:ring-offset-zinc-900 hover:ring-brand-500"
            >
                Quero enviar outro
            </button>
        </>
